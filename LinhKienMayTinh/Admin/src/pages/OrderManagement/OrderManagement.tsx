  ...
  return (
    <div className='bg-white mt-2 py-5'>
      <div className='container'>
        <div className='font-semibold text-3xl mb-4'>Quản lý đơn hàng</div>
        <div className='flex items-center p-4'>
          <div className='grid grid-cols-3'>
            <div className='mr-4 col-span-2 mt-3'>
              <span className='text-gray-600'>Tổng đơn hàng:</span> <span className='font-bold'>2</span>
        ...
        <div className='grid grid-cols-12 rounded-sm bg-white py-5 px-8 text-sm capitalize text-gray-500 shadow'>
          <div className='col-span-1'>
            <div className='flex items-center'>
              ...
              <div className='flex-grow text-black'>Mã</div>
            </div>
          </div>
          <div className='col-span-11'>
            <div className='grid text-center grid-cols-11'>
              ...
              <div className='col-span-1'>Thông tin</div>
            </div>
          </div>
        </div>
          ...
          <div className='grid grid-cols-12 rounded-sm bg-white py-5 px-8 text-sm capitalize text-gray-500 shadow'>
            <div className='col-span-1'>
              <div className='flex items-center'>
                ...
                <div className='flex-grow text-black'>DH001</div>
              </div>
            </div>
            <div className='col-span-11'>
              <div className='grid text-center grid-cols-11'>
                <div className='col-span-2'>Nguyễn Văn A</div>
                <div className='col-span-2'>Đang giao</div>
                <div className='col-span-2'>Tiền mặt</div>
                <div className='col-span-2'>20-01-2024</div>
                <div className='col-span-2'>100.000</div>
                <div className='col-span-1'>
                  <Link to=' ' className='bg-orange px-2 py-2 border text-white hover:bg-[#e56b17]'>
                    Chi tiết
                  </Link>
                </div>
              </div>
