...
export default function Header() {
  ...
  const onSumbitSearch = handleSubmit((data) => {
    ...
    <div className='pb-5 pt-2 bg-[#f58420] text-white'>
      <div className='container'>
        <div className='flex justify-end'>
          <Popover
            className='flex item center py-1  hover:text-white/70 cursor-pointer'
            renderPopover={
              <div className='bg-white relative shadow-md rounded-sm border border-gray-200'>
                <div className='flex flex-col py-2 pr-28 pl-3'>
                  <div className='py-3 px-3 hover:text-orange'>Tiếng Việt</div>
                  <div className='py-3 px-3 hover:text-orange'>English</div>
                </div>
              </div>
            }
          >
          ...
          {isAuthenticated && (
            <Popover
              className='flex item center py-1  hover:text-white/70 cursor-pointer ml-6'
              renderPopover={
                <div className='bg-white relative shadow-md rounded-sm border border-gray-200'>
                  <Link
                    to={path.profile}
                    ...
                    <div className='mt-5'>
                      <div className='mt-4 flex'>
                        <div className='flex-shrink-0'>
                          <img
                            src='https://product.hstatic.net/200000420363/product/vga-asus-gtx-1660-super-6g-tuf-gaming-2-fan-tuf-gtx1660s-o6g-gaming_418509832d134d09af8fb23c1e06e717_master.jpg'
                            alt='anh'
                            className='w-11 h-11 object-cover'
                          />
                        </div>
                        <div className='flex-grow ml-2 overflow-hidden'>
                          <div className='truncate'>Card màn hình VGA Asus GTX 1660 Super TUF Gaming OC 6G 2 Fan</div>
                        </div>
                        <div className='ml-2 flex-shrink-0'>
                          <span className='text-orange'>4,790,000₫</span>
                        </div>
                      </div>
                      <div className='mt-4 flex'>
                        <div className='flex-shrink-0'>
