              ...
              <div>
                <div className='flex flex-col'>
                  <svg
                    ...
                    height='100'
                    viewBox='0 0 48 48'
                    className='h-8 md:h-11 fill-orange'
                  >
                    <path
                      fill='#f58420'
                  ...
                  <div className='text-center font-semibold text-[#f58420]'>FLYER</div>
                </div>
              </div>
              <div className='mx-4 h-6 md:h-8 w-[1px] bg-orange' />
              <div className='capitalize text-orange md:text-xl'>Giỏ hàng</div>
            </Link>
            <form className='mt-3 md:mt-0 md:w-[50%]' onSubmit={onSumbitSearch}>
              <div className='bg-white rounded-sm p-1 flex border-2 border-orange'>
                <input
                  type='text'
                  ...
                  {...register('name')}
                />
                <button className='rounded-sm py-2 px-8 flex-shrink-0 bg-[#f58420] hover:opacity-90'>
                  <svg
                    xmlns='http://www.w3.org/2000/svg'
                    fill='none'
                    viewBox='0 0 24 24'
